...
execute if score startdelay dataumpt matches 1 run scoreboard players operation delay dataumpt = delayby persistent
...
#make blue portal
execute store success score blueportal dataumpt run data get entity @e[type=minecraft:trident,limit=1,nbt={Trident:{tag:{blue:1}}}] inBlockState.Name
execute if score blueportal dataumpt matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{blue:1}}}] run fill ~2 ~4 ~ ~-1 ~ ~ minecraft:blue_wool replace air
execute if score blueportal dataumpt matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{blue:1}}}] run fill ~1 ~3 ~ ~ ~1 ~ minecraft:blue_stained_glass_pane replace blue_wool
...
execute if score blueportal dataumpt matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{blue:1}}}] run tp @e[type=minecraft:armor_stand,nbt={Tags:["blue:1"]}] ~.5 ~1.5 ~
execute if score blueportal dataumpt matches 1 at @e[type=minecraft:armor_stand,nbt={Tags:["blue:1"]}] run forceload add ~ ~
execute if score blueportal dataumpt matches 1 run kill @e[type=minecraft:trident,nbt={Trident:{tag:{blue:1}}}]
...
#make orange portal
execute store success score orangeportal dataumpt run data get entity @e[type=minecraft:trident,limit=1,nbt={Trident:{tag:{orange:1}}}] inBlockState.Name
execute if score orangeportal dataumpt matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{orange:1}}}] run fill ~2 ~4 ~ ~-1 ~ ~ minecraft:orange_wool replace air
execute if score orangeportal dataumpt matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{orange:1}}}] run fill ~1 ~3 ~ ~ ~1 ~ minecraft:orange_stained_glass_pane replace orange_wool
...
execute if score orangeportal dataumpt matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{orange:1}}}] run tp @e[type=minecraft:armor_stand,nbt={Tags:["orange:1"]}] ~.5 ~1.5 ~
execute if score orangeportal dataumpt matches 1 at @e[type=minecraft:armor_stand,nbt={Tags:["orange:1"]}] run forceload add ~ ~
execute if score orangeportal dataumpt matches 1 run kill @e[type=minecraft:trident,nbt={Trident:{tag:{orange:1}}}]
